        ...
        child: Column(
          ...
          children: [
                ...
                const Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text("MBBS, MD - General Physician",
                          style: TextStyle(color: Colors.grey)),
                      SizedBox(height: 6),
                      Row(
                        children: [
                          Chip(label: Text("98% Positive")),
                          SizedBox(width: 6),
            ...
            Wrap(
              spacing: 10,
              children: [
                chip("Internal Medicine", Icons.school),
                chip("Public Health", Icons.workspace_premium),
                chip("12+ Years Exp", Icons.timeline),
              ],
            ),
            ...
            Row(
              ...
              children: const [
                ...
                Text("October", style: TextStyle(color: Colors.grey)),
              ],
            ),
